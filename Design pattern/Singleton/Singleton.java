...
public static void main(String[] args) throws InterruptedException {
    //Eager DB
    System.out.println(" 1) Using Eager Initialization ####");
    ...
    //Synchornized DB
    System.out.println("\n 3) Using Synchronized LAZY Initialization ####");
    Runnable task=()->{
    ...
    System.out.println("\n 4) Using Duble checked Synchronized LAZY Initialization ####");
    Runnable task1=()->{
    ...
    t6.join();
     ...
     //Bill Pugh DB 
    System.out.println("\n 5) Using Bill Pugh Initialization ####");
    ...
    //Enum DB 
    System.out.println("\n 6)  Using Enum DB Initialization ####");
    EnumDB enumdb = EnumDB.DBINSTANCE;
    EnumDB enumdb2 = EnumDB.DBINSTANCE;
    enumdb.executeQuery("Update Column X");
    System.out.println("is intances same ? "+ (enumdb==enumdb2)+"\n");
}
}
